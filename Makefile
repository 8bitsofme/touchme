...
AVRDUDE_PORT = /dev/tty.usbserial-A400XJJP    # not really needed for usb 
...
#CFLAGS += -std=c99
CFLAGS += -std=gnu99
CFLAGS += -DTLC5940_N=$(TLC5940_N) -DF_CPU=$(F_CPU) -DMAX_LIT=$(MAX_LIT) -DMIN_RATE=$(MIN_RATE) -DMAX_RATE=$(MAX_RATE) -DBASE_INTENSITY=$(BASE_INTENSITY) -DMAX_INTENSITY=$(MAX_INTENSITY) -DMAX_LIT_DEMO=$(MAX_LIT_DEMO)
